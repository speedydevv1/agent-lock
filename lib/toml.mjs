...
// Config is untrusted input, never a route into Object.prototype or a constructor.
function rejectPrototypeKeys(parts) {
  if (parts.some((p) => ['__proto__', 'constructor', 'prototype'].includes(p)))
    throw new Error('toml: reserved prototype key');
}
